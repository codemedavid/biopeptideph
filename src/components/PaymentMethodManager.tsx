            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 py-3 sm:py-0 sm:h-16">
              <div className="flex items-center space-x-2 sm:space-x-4 w-full sm:w-auto">
                <button
                  ...
                  className="flex items-center space-x-1 sm:space-x-2 text-gray-700 hover:text-theme-accent transition-colors duration-200"
                >
              ...
              <div className="flex space-x-2 sm:space-x-3 w-full sm:w-auto">
                <button
                  onClick={handleCancel}
                  className="flex-1 sm:flex-none px-3 sm:px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors duration-200 flex items-center justify-center space-x-1 sm:space-x-2 text-sm sm:text-base"
                >
                  <X className="h-4 w-4" />
                ...
                <button
                  ...
                  className="flex-1 sm:flex-none px-3 sm:px-4 py-2 bg-gradient-to-r from-black to-gray-900 hover:from-gray-900 hover:to-black text-white rounded-lg transition-all duration-200 flex items-center justify-center space-x-1 sm:space-x-2 shadow-lg hover:shadow-xl border border-gray-200 text-sm sm:text-base"
                >
            ...
            <div className="space-y-4 sm:space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-theme-accent focus:border-theme-accent transition-colors"
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-theme-accent focus:border-theme-accent transition-colors disabled:bg-gray-50"
              ...
              <div className="flex items-center">
                <label className="flex items-center space-x-2 cursor-pointer">
                  <input
                    ...
                    className="w-4 h-4 rounded border-gray-300 text-theme-accent focus:ring-theme-accent cursor-pointer"
                  />
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 py-3 sm:py-0 sm:h-16">
            ...
            <button
              ...
              className="w-full sm:w-auto flex items-center justify-center space-x-2 bg-gradient-to-r from-black to-gray-900 hover:from-gray-900 hover:to-black text-white px-3 sm:px-4 py-2 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl border border-gray-200 text-sm sm:text-base"
            >
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
          <div className="p-4 sm:p-6">
            <h2 className="text-base sm:text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
              <CreditCard className="w-4 h-4 sm:w-5 sm:h-5 text-theme-secondary" />
              Payment Methods
            </h2>
            ...
            {paymentMethods.length === 0 ? (
              <div className="text-center py-8">
                ...
                <button
                  onClick={handleAddMethod}
                  className="bg-gradient-to-r from-black to-gray-900 hover:from-gray-900 hover:to-black text-white px-4 py-2 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl border border-gray-200 text-sm sm:text-base"
                >
              ...
              <div className="space-y-3 sm:space-y-4">
                {paymentMethods.map((method) => (
                  <div
                    key={method.id}
                    className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 p-3 sm:p-4 border border-gray-200 rounded-lg hover:border-theme-accent/30 transition-all duration-200"
                  >
                    <div className="flex items-center space-x-3 sm:space-x-4 w-full sm:w-auto">
                      <div className="flex-shrink-0">
                        <img
                          ...
                          className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg border border-gray-200 object-cover"
                          onError={(e) => {
                    ...
                    <div className="flex items-center space-x-2 sm:space-x-3 w-full sm:w-auto justify-end sm:justify-start">
                      ...
                      <button
                        ...
                        className="p-2 text-gray-400 hover:text-theme-accent hover:bg-theme-accent/5 rounded-lg transition-colors duration-200"
                        aria-label="Edit"
                      >
