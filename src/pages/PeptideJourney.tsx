    ...
    return (
        <div className="min-h-screen bg-gray-50 relative">
            ...
            <section className="py-24 bg-theme-navy text-white relative overflow-hidden">
                <div className="container mx-auto px-4 relative z-10 text-center">
                    <h2 className="text-3xl md:text-4xl font-bold mb-16">{get('values', 'title', 'Why Diamond Glow Exists')}</h2>
                    <p className="max-w-2xl mx-auto mb-12 text-gray-300">{get('values', 'content', 'This journey is why Diamond Glow exists.')}</p>
